...
test.describe("Case Studies & Clients Page", () => {
  test.beforeEach(async ({page}) => {
    await page.goto("https://aspiritech.org/case-studies/")
  })
...
test("Validate the Komodo Health case study section", async ({page}) => {
    ...
    await expect(page).toHaveURL('https://aspiritech.org/aspiritech-press/komodo-case-study/')
    await expect(page.getByRole('heading', { name: 'Komodo Case Study' })).toBeVisible();
    await page.goBack()

    await expect(page.locator('body')).toMatchAriaSnapshot(`
      - link:
        - /url: https://aspiritech.org/aspiritech-press/komodo-case-study/
...
test("JPMorgan Chase Case Study section", async ({page}) => {
    ...
    await expect(page).toHaveURL("https://aspiritech.org/aspiritech-press/jpmc-case-study/")
    await expect(page.getByRole('heading', { name: 'JPMorgan Chase Case Study' })).toBeVisible();
    await page.goBack()
    await expect(page.locator('body')).toMatchAriaSnapshot(`
      - link:
        - /url: https://aspiritech.org/aspiritech-press/jpmc-case-study/
...
test("Basecamp Case Study section", async ({page}) => {
    ...
    await expect(page).toHaveURL("https://aspiritech.org/aspiritech-press/basecamp-case-study/")
    await expect(page.getByRole('heading', { name: 'Basecamp Case Study' })).toBeVisible();
    await page.goBack()
    await expect(page.locator('body')).toMatchAriaSnapshot(`
      - link:
        - /url: https://aspiritech.org/aspiritech-press/basecamp-case-study/
...
test("SourceAmerica Case Study section", async ({page}) => {
    ...
    await expect(page).toHaveURL("https://aspiritech.org/aspiritech-press/source-america-case-study/")
    await expect(page.getByRole('heading', { name: 'SourceAmerica Case Study' })).toBeVisible();
    await page.goBack()
    await expect(page.locator('body')).toMatchAriaSnapshot(`
      - link:
        - /url: https://aspiritech.org/aspiritech-press/source-america-case-study/
...
test("Goldman Sachs Case Study section", async ({page}) => {
    ...
    await expect(page).toHaveURL("https://aspiritech.org/aspiritech-press/goldman-sachs-case-study/")
    await expect(page.getByRole('heading', { name: 'Goldman Sachs Case Study' })).toBeVisible();
    await page.goBack()
    await expect(page.locator('body')).toMatchAriaSnapshot(`
      - link "A male Aspiritech QA analyst in a blue-gray shirt and glasses looks toward a man in a black shirt in glasses.":
        - /url: https://aspiritech.org/aspiritech-press/goldman-sachs-case-study/
